...
def Completed(Message,AllInfo,CheckInfo,GId,vk,Subj,About,Pass,Gid_2): 
    ...
    elif CheckInfo[1] == 'NewYear':   ############## Удалить после НГ
        Wish = ['С НГ!','С НоВыМ ГоДаМ','А где ёлка?','Иди учи уроки!',
                'У меня закончились идеи(','Какая-то китайская мудрость...',
                'Я только бот, но мои братья уже захватывают мир...&#128126;',
                '&#128530;','А вот и я!!!','Счастья, радости желаю!!!']
        MesNum = random.randint(0, 9)
        Result = Wish[MesNum]     ############## Удалить после НГ
...
#Уроки в моём классе.
Subj = {
    '1' : ['Химия','Всемирная история','Англ. яз','Бел. лит.','Математика','Физра',''],
    '2' : ['Черчение-','Биология','Физра','Математика','Математика','Англ. яз',''], 
    '3' : ['История Беларуси','Англ. яз','Бел. яз.','Белорусская лит.','Физика','Математика','Математика'], 
    '4' : ['Русск. яз.','Русск. лит.','Химия','Информатика','Англ. яз.','Физра','География'], 
    '5' : ['Англ. яз.', 'Биология', 'ДМП','Обществовединие','Математика','Физика','Кл. час']
    }
...
Commands = [
    ...
    '10. Секретная команда, кто догадается как она пишется - молодец и получит рандомный ответ. Подсказка: связанно с НГ, 4 буквы на русском языке.' ######             
]
About = ''
